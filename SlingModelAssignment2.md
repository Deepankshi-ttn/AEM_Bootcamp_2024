Question 2: Create one sling model and display the values.Show usecase and describe these annotations @Inject, @PostConstruct, @OsgiService, @ScriptVariable, @Optional/@Required.
